...
public class WSDLPartnerLinkParser implements ElementParser<Definition> {
	final public static String PARTNER_LINK_TYPE_NS ="http://docs.oasis-open.org/wsbpel/2.0/plnktype";
	final public static QName PARTNER_LINK_TYPE = new QName(PARTNER_LINK_TYPE_NS,"partnerLinkType");
	...
	public void parse(XMLStreamReader input, Definition def, WSDLCompilerContext context) throws XMLStreamException, ParserException {
		while (input.hasNext()) {
			...
			case XMLStreamConstants.START_ELEMENT:
				ParserUtils.assertStart(input, PARTNER_LINK_TYPE);
			...
			case XMLStreamConstants.END_ELEMENT:
				ParserUtils.assertEnd(input, PARTNER_LINK_TYPE);
				return;
			}
		}
