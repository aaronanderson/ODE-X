...
import org.apache.ode.runtime.exec.platform.task.InstallAction;
import org.apache.ode.runtime.exec.platform.task.InstallSlaveAction;
...
import org.apache.ode.server.ExecutorsImpl;
...
public class RuntimeHandler extends Handler {
	...
	public void beforeBeanDiscovery(BeforeBeanDiscovery bbd, BeanManager bm) {
		...
		bbd.addAnnotatedType(bm.createAnnotatedType(ExecutorsImpl.class));
		bbd.addAnnotatedType(bm.createAnnotatedType(HealthCheck.class));
		bbd.addAnnotatedType(bm.createAnnotatedType(TaskPoll.class));
		bbd.addAnnotatedType(bm.createAnnotatedType(TaskExecutor.class));
		bbd.addAnnotatedType(bm.createAnnotatedType(InstallAction.class));
