...
@Parameters(separators = "=", commandDescription = "List the types of artifacts supported by the repository")
public class ListTypesCommand extends AbstractCommand{

	public ListTypesCommand(Connection connection, Formatter out) {
