...
@Parameters(separators = "=", commandDescription = "Uninstalls an executable from the machine")
public class UninstallCommand extends AbstractCommand{
   
  public UninstallCommand(Connection connection, Formatter out) {
...
@Parameter(names = "--name", description = "Executable name", required = true)
  ...
  @Parameter(names = "--kill", description = "Kill all running instances if any")
  public boolean kill;
