...
public class ParserRegistry extends AbstractHandlerRegistry<Unit,ParserException, XSDCompilerContext, ElementParser<? extends Unit>, AttributeParser<? extends Unit>> {
