 ...
 * 
 */
public class XSDCompilerContext extends
		AbstractXMLCompilerContext<Unit, ParserException, XSDCompilerContext, ElementParser<? extends Unit>, AttributeParser<? extends Unit>> {
