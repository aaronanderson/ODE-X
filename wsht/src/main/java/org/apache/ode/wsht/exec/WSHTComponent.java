 ...
 * under the License.
 */
package org.apache.ode.wsht.exec;
...
public class WSHTComponent implements Component {

	public static final String WSHT_INSTRUCTION_SET_NS = "http://ode.apache.org/wsht";
	public static final QName WSHT_INSTRUCTION_SET = new QName(WSHT_INSTRUCTION_SET_NS, "WSHT");

	@Override
	public QName name() {
		return WSHT_INSTRUCTION_SET;
	}
