...
import static org.apache.ode.spi.compiler.wsdl.Binding.BINDING;
...
public class BindingParser implements ElementParser<Definition> {
	...
	public void parse(XMLStreamReader input, Definition def, WSDLCompilerContext context) throws XMLStreamException, ParserException {
		while (input.hasNext()) {
			...
			case XMLStreamConstants.START_ELEMENT:
				ParserUtils.assertStart(input, BINDING);
			...
			case XMLStreamConstants.END_ELEMENT:
				ParserUtils.assertEnd(input, BINDING);
				return;
			}
		}
