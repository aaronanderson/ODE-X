...
import static org.apache.ode.spi.compiler.wsdl.Service.SERVICE;
...
public class ServiceParser implements ElementParser<Definition> {
	...
	public void parse(XMLStreamReader input, Definition def, WSDLCompilerContext context) throws XMLStreamException, ParserException {
		while (input.hasNext()) {
			...
			case XMLStreamConstants.START_ELEMENT:
				ParserUtils.assertStart(input, SERVICE);
			...
			case XMLStreamConstants.END_ELEMENT:
				ParserUtils.assertEnd(input, SERVICE);
				return;
			}
		}
